...
\N{descend\_and\_lock} function performs this traversal. Unlike
\N{descend}, \N{descend\_and\_lock} descends across multiple layers.
It returns the unique node that would contain the value for \(k\) if
\(k\) were in the current tree.
